...
```{r, echo=FALSE}
knitr::include_graphics("~/Documents/Teaching/ConsSocMedia/slides/misc/grantTidyverse.png")
```

3. Select `Allow`. Next, you will see:

```{r, echo=FALSE, out.height="700px"}
knitr::include_graphics("~/Documents/Teaching/ConsSocMedia/slides/misc/permissions.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("~/Documents/Teaching/ConsSocMedia/slides/misc/RStudioOAuthCopyCode.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("~/Documents/Teaching/ConsSocMedia/slides/misc/RStudioServerInitAuth.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("~/Documents/Teaching/ConsSocMedia/slides/misc/RStudioServerCopiedAuthKey.png")
```
